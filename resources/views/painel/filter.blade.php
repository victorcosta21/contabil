		  ...
		  <div class="modal-body">
				<form class="form-group" action="">
					<div class="form-group row">
						<div class="col-md-12">
							<label>Nome</label>
							<input type="text" name="name" class="form-control" maxlength="40" placeholder="Filtre pelo nome do cliente">
						</div>
					</div>
					<div class="form-group row mt-2">
						<div class="form-group col-md-5">
							<label>Número de Conta</label>
							<input type="text" name="accountNumber" class="form-control" maxlength="5" placeholder="00000">
						</div>
						<div class="form-group col-md-7">
							<label>Documento</label>
							<input type="text" name="document" class="form-control document" id="document" placeholder="CPF / CNPJ">
						</div>
					</div>
